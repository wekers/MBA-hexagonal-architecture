...
class EventControllerTest {
    ...
    void setUp() {
        ...
        johnDoe = customerRepository.create(Customer.newCustomer("John Doe", "123.983.885-65", "john@gmail.com"));
        disney = partnerRepository.create(Partner.newPartner("Disney", "45.600.500/0001-20", "disney@gmail.com"));
    }
